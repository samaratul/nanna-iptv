...
Checked **3801** streams — **2872 working**, **929 dead** (24.4% dead).
...
- ❌ **NCIS: Los Angeles (Sweden)** — HTTP 404  
...
## English - Entertainment (1719/2185 working)
...
- ❌ **AXN (Brazil) (720p)** — connection error: timed out  
...
- ❌ **Avatar (Sweden)** — HTTP 404  
  `https://jmp2.uk/plu-61c09b48d6d97900076e91c5.m3u8`
- ❌ **Auction Hunters (Sweden) DK** — HTTP 404  
...
- ❌ **ABC (1080p)** — connection error: timed out  
...
- ❌ **Boligkob i blinde** — HTTP 404  
  `https://jmp2.uk/plu-63c6a27a4faf1c0007b48f7b.m3u8`
- ❌ **Bondi Rescue (Sweden) DK (720p)** — HTTP 404  
...
- ❌ **Britain's Next Top Model DK** — HTTP 404  
...
- ❌ **Car Chase (Sweden) DK (720p)** — HTTP 404  
  `https://jmp2.uk/plu-65a93b0607e03a000895abda.m3u8`
- ❌ **Caroline in the City DK** — HTTP 404  
...
- ❌ **CBS KMOV (1080p)** — connection error: [Errno 111] Connection refused  
  `http://best.happytv.xyz:2082/live/JThibodeau0923/gcEyG7W3/2193473.m3u8`
...
- ❌ **Comedy Central (Sweden) DK (720p)** — HTTP 404  
...
- ❌ **Crazy Ex-Girlfriend DK** — HTTP 404  
...
- ❌ **Dallas Cowboys Cheerleaders DK** — HTTP 404  
  `https://jmp2.uk/plu-64e87c6b28cec700088ceb55.m3u8`
- ❌ **Dating Naked UK DK** — HTTP 404  
...
- ❌ **Everybody Hates Chris DK** — HTTP 404  
...
- ❌ **Family Ties (Sweden) DK** — HTTP 404  
...
- ❌ **Gustav & Linse pa udebane** — HTTP 404  
...
- ❌ **Freeform (720p)** — connection error: timed out  
...
- ❌ **Jersey Shore (Sweden) DK** — HTTP 404  
  `https://jmp2.uk/plu-6442508e5a0cd500083edd3c.m3u8`
- ❌ **Jersey Shore Family Vacation DK** — HTTP 404  
...
- ❌ **MasterChef Danmarks storste madtalenter** — HTTP 404  
...
- ❌ **Medium (Sweden) DK** — HTTP 404  
  `https://jmp2.uk/plu-68f0f54ca362b63a8df4d5a9.m3u8`
- ❌ **Merry Christmas from Viafree DK** — HTTP 404  
...
- ❌ **Mission Impossible (Sweden) DK** — HTTP 404  
...
- ❌ **NonStop Kung Fu DK** — HTTP 404  
  `https://jmp2.uk/plu-6728d2be529ac9000830dc15.m3u8`
- ❌ **Numbers (Sweden)** — HTTP 404  
...
- ❌ **Overcomers TV (720p)** — connection error: timed out  
...
- ❌ **Sabrina the Teenage Witch DK** — HTTP 404  
  `https://jmp2.uk/plu-6512ecf63a0d700008db506a.m3u8`
- ❌ **Scorpion (Sweden) DK** — HTTP 404  
...
- ❌ **Totally Turtles (Sweden) DK (720p)** — HTTP 404  
...
- ❌ **TVP World** — HTTP 404  
  `https://dash2.antik.sk/live/test_tvp_world/playlist.m3u8`
...
## English - Lifestyle (86/168 working)
- ❌ **CS History** — HTTP 404  
...
- ❌ **CommunityTV Channel 189 (1080p) [Geo-blocked]** — HTTP 403  
...
- ❌ **FashionBox** — HTTP 404  
  `https://dash2.antik.sk/live/test_fashionbox_medium_atk/playlist.m3u8`
- ❌ **Geordie Shore (Sweden) DK** — HTTP 404  
...
- ❌ **Pluto TV Film (Sweden) DK** — HTTP 404  
...
- ❌ **Viafree Movies DK** — HTTP 404  
  `https://jmp2.uk/plu-62bebc3459624e00078209c3.m3u8`

## English - Music (110/132 working)
...
- ❌ **MTV Chontales (720p) [Not 24/7]** — connection error: timed out  
  `https://altair.hostingnica.net/hls/mtv_stream/index.m3u8`

## English - Sports (51/73 working)
...
- ❌ **Pluto TV Sport (Sweden) DK** — HTTP 404  
...
- ❌ **Sky Sports Cricket (United Kingdom) HD** — HTTP 404  
...
## Hindi - Entertainment (298/372 working)
...
- ❌ **Sony Channel (Brazil) (720p)** — connection error: timed out  
  `http://170.83.16.50/SONY_CHANNEL/index.m3u8`
...
- ❌ **Pluto TV Star Trek (Sweden)** — HTTP 404  
  `https://jmp2.uk/plu-61c1979dfa307000070bbe4d.m3u8`
- ❌ **Star Trek: The Original Series (Sweden) DK** — HTTP 404  
  `https://jmp2.uk/plu-693add137e308621c051e733.m3u8`
- ❌ **South Park: Into the Stars DK** — HTTP 404  
...
- ❌ **Prarthana Bhawan TV (576p)** — timeout/os error: The read operation timed out  
...
- ❌ **News Nation 81 (1080p)** — HTTP 404  
  `https://live.newsnation81.com/newsnation81/newsnation81/index.m3u8`
...
## Hindi - Sports (16/16 working)
- ✅ all working

## Nepali - Devotional (3/3 working)
- ✅ all working

## Nepali - Entertainment (49/65 working)
...
- ❌ **FashionTV Asia (720p)** — connection error: [Errno 111] Connection refused  
