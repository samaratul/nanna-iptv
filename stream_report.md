...
Checked **3767** streams — **2965 working**, **802 dead** (21.3% dead).

## Bhojpuri - Entertainment (6/13 working)
...
## English - Entertainment (1820/2097 working)
...
- ❌ **ABC West (720p)** — HTTP 404  
  `http://stream.cammonitorplus.net/1797/index.m3u8`
...
## English - Lifestyle (130/194 working)
...
- ❌ **Bharat Express (576p)** — timeout/os error: The read operation timed out  
  `https://mumt07.tangotv.in/zHjX9OFlBHARATEXPRESS/index.m3u8`
...
## Hindi - Entertainment (248/376 working)
...
- ❌ **Jantantra TV (576p)** — HTTP 404  
  `https://mumt05.tangotv.in/87NeALx2JANTANTRA/index.m3u8`
...
- ❌ **Soham TV (576p)** — timeout/os error: The read operation timed out  
...
- ❌ **Vedic (576p)** — timeout/os error: The read operation timed out  
...
- ❌ **Goldmines Bollywood (576p)** — timeout/os error: The read operation timed out  
...
- ❌ **Bharat Samachar (576p)** — timeout/os error: The read operation timed out  
  `https://mumt03.tangotv.in/Dsly5z3HBHARATSAMACHAR/index.m3u8`
- ❌ **Zee 24 Ghanta (576p)** — connection error: timed out  
  `http://45.148.145.57/IN_Zee24Ghanta/index.m3u8`
- ❌ **Argus News (576p)** — HTTP 404  
  `https://mumt05.tangotv.in/87NeALx2ARGUSNEWS/index.m3u8`
- ❌ **Bansal News (720p)** — HTTP 401  
  `https://8yzmq2gbdvax-hls-live.wmncdn.net/bansalnewstv1/live1.stream/playlist.m3u8`
- ❌ **Bharat24 (576p)** — HTTP 404  
  `https://streams.tangotv.in/BHARAT24/ORIGIN/index.m3u8`
- ❌ **First India News (576p)** — HTTP 404  
  `https://mumt03.tangotv.in/Dsly5z3H1STINDIANEWS/index.m3u8`
- ❌ **Aaj Tak (1080p)** — connection error: timed out  
  `http://103.213.31.109:90/AajtakHD/playlist.m3u8`
- ❌ **Ind 24 (576p)** — HTTP 404  
  `https://mumt06.tangotv.in/qYyB8fXVIND24/index.m3u8`
...
- ❌ **Sadhna News Madhya Pradesh/Chhattisgarh (576p)** — HTTP 404  
  `https://mumt04.tangotv.in/m18aqlK4SADHNEWSPMRAJ/index.m3u8`
- ❌ **Samachar Plus 24x7 (576p)** — HTTP 404  
  `https://mumt05.tangotv.in/87NeALx2VERTENTSAMACHARPLUS/index.m3u8`
...
- ❌ **News 1 India (576p)** — timeout/os error: The read operation timed out  
  `https://mumt07.tangotv.in/zHjX9OFlNEWS1INDIA/index.m3u8`
...
## Nepali - Entertainment (46/60 working)
- ❌ **NTV Kenya** — HTTP 404  
