...
Checked **3809** streams — **3011 working**, **798 dead** (21.0% dead).
...
## English - Entertainment (1844/2192 working)
...
- ❌ **Government TV 16 (720p)** — HTTP 404  
...
- ❌ **Hype Visual Radio (1080p)** — HTTP 404  
...
## English - Lifestyle (85/168 working)
- ❌ **CS History** — HTTP 502  
...
- ❌ **CAtv (1080p) [Not 24/7]** — got HTML/error page instead of stream  
...
- ❌ **National Geographic (India) (576p) [Geo-blocked]** — HTTP 407  
...
- ❌ **News Capital Market (1080p)** — timeout/os error: The read operation timed out  
  `https://newscapital.com/hls/stream.m3u8?token=Nc360PermanentSecureKey987`
