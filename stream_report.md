...
Checked **3884** streams — **3063 working**, **821 dead** (21.1% dead).
...
- ❌ **God Stands TV English** — connection error: [Errno -3] Temporary failure in name resolution  
  `https://online.godstands.tv:5443/WebRTCApp/streams/EnglishStreaming.m3u8`
- ❌ **God Stands Kids Club TV English** — connection error: [Errno -3] Temporary failure in name resolution  
  `https://online.godstands.tv:5443/WebRTCApp/streams/kidsenglish.m3u8`
- ❌ **God Stands TV** — connection error: [Errno -3] Temporary failure in name resolution  
...
## English - Entertainment (1901/2219 working)
...
- ❌ **Buena Park Television (360p)** — HTTP 403  
...
- ❌ **AP TV** — connection error: [Errno -3] Temporary failure in name resolution  
...
- ❌ **Golden Community Television (GCO.tv) (Golden CO) (1080p)** — HTTP 403  
...
- ❌ **KBRI Brighton Channel 8 (Brighton CO) (720p)** — HTTP 403  
...
- ❌ **Leesburg Lakefront TV (Leesburg FL) (720p)** — HTTP 403  
...
- ❌ **HBO Hits (720p)** — timeout/os error: timed out  
...
- ❌ **Manatee Schools Television MSTV (Manatee County FL) (1080p)** — HTTP 403  
...
- ❌ **NCM Government & Politics** — HTTP 403  
...
- ❌ **People Are Awesome (1080p)** — HTTP 404  
  `https://mumbai-edge.smartplaytv.in/PeopleAreAwesome/index.m3u8`
- ❌ **Nick HD+ (1080p)** — connection error: timed out  
  `http://103.72.101.252:8080/live/1226.m3u8`
- ❌ **Nickelodeon (576p)** — timeout/os error: timed out  
...
- ❌ **Pomona Internet Streaming Channel (Pomona CA) (720p)** — HTTP 403  
  `https://reflect-pomona.cablecast.tv/live-1/live/live.m3u8`
- ❌ **Poudre School District TV (PSD TV) (Fort Collins CO) (720p)** — HTTP 403  
...
- ❌ **SCVTV (Santa Clarita CA) (1080p)** — HTTP 403  
  `https://reflect-scvtv.cablecast.tv/live-2/live/live.m3u8`
- ❌ **SF Commons Channel 29 (San Francisco CA) (480p)** — HTTP 403  
  `https://reflect-bayarea.cablecast.tv/live-5/live/live.m3u8`
- ❌ **SF Commons Channel 76 (San Francisco CA) (480p)** — HTTP 403  
...
- ❌ **TeenNick (576p)** — timeout/os error: timed out  
...
- ❌ **TUTV (1080p)** — connection error: [Errno -2] Name or service not known  
...
- ❌ **UTV Africa (720p)** — connection error: [Errno -5] No address associated with hostname  
...
- ❌ **Haddam Killingworth High School TV (HKTV) (1080p) [Geo-blocked]** — HTTP 403  
...
- ❌ **National Geographic HD East (720p)** — HTTP 404  
...
- ❌ **Waffi TV (240p)** — connection error: [Errno -5] No address associated with hostname  
...
- ❌ **Fox Sports 2 (720p)** — timeout/os error: The read operation timed out  
...
- ❌ **Sky Sports Cricket (1080p)** — connection error: [Errno -2] Name or service not known  
  `https://leaf.highfly.dev/m3u/now-sky-sports-cricket/live.m3u8`
- ❌ **Sky Sports F1 (1080p)** — HTTP 401  
  `https://xemzi.short.gy/2000005`
- ❌ **Sky Sports Golf HD (1080p)** — connection error: [Errno -2] Name or service not known  
...
## Hindi - Devotional (14/17 working)
...
- ❌ **God Stands TV Hindi** — connection error: [Errno -3] Temporary failure in name resolution  
  `https://online.godstands.tv:5443/WebRTCApp/streams/HindiStreaming.m3u8`

## Hindi - Entertainment (281/392 working)
...
- ❌ **SVBC 4 (1080p)** — connection error: [Errno -2] Name or service not known  
...
- ❌ **Zee Cinemalu HD (720p)** — HTTP 404  
  `https://mumbai-edge.smartplaytv.in/ZeeCinemaluHD/index.m3u8`
...
- ❌ **Bansal News (720p)** — connection error: [Errno -3] Temporary failure in name resolution  
...
- ❌ **Bada Khabar (576p)** — timeout/os error: The read operation timed out  
  `https://mumbai-edge.smartplaytv.in/BADAKHABAR/index.m3u8`
...
## Nepali - Entertainment (47/62 working)
...
## Nepali - News (16/19 working)
- ❌ **City TV Capital City Connection [Not 24/7]** — HTTP 403  
