...
Checked **4092** streams — **3169 working**, **923 dead** (22.6% dead).

## Bhojpuri - Entertainment (8/12 working)
- ❌ **Manoranjan Grand (720p)** — got HTML/error page instead of stream  
...
## English - Entertainment (2047/2363 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **AXN Latin America Andes (1080p)** — HTTP 404  
...
- ❌ **AXN Spin (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/axnspin/index.m3u8`
...
- ❌ **AMC Europe Romania (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/amc/index.m3u8`
...
- ❌ **AXN CEE Romania (720p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/axn/index.m3u8`
- ❌ **AXN White (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/axnwhite/index.m3u8`
- ❌ **B+ TV (480p)** — HTTP 404  
...
- ❌ **AXN Black Romania (406p)** — timeout/os error: The read operation timed out  
  `https://aes.m3u8simplu.workers.dev/axnblack/index.m3u8`
- ❌ **CFM TV Channel 98 (360p)** — HTTP 404  
...
- ❌ **Comedy Central (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/comedycentral/index.m3u8`
...
- ❌ **Disney Junior (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/disneyjunior/index.m3u8`
...
- ❌ **Great Commission TV** — connection error: [Errno 111] Connection refused  
...
- ❌ **Hi Dost! (720p)** — got HTML/error page instead of stream  
...
- ❌ **JimJam (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/jimjam/index.m3u8`
...
- ❌ **Kaloopy TV (1080p)** — timeout/os error: The read operation timed out  
...
- ❌ **Nick Jr. (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/nickjr/index.m3u8`
- ❌ **Nick Jr. (576p)** — HTTP 404  
  `http://bethoven.af-stream.com:1600/s/kwtlxswl/nick-jr-il/video.m3u8`
- ❌ **Nicktoons (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/nicktoons/index.m3u8`
- ❌ **Nickelodeon West (1080p)** — HTTP 403  
  `https://sra72yz.s.gy/NICK_WEST_US`
...
- ❌ **PRO TV International (1080p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/protvint/index.m3u8`
...
- ❌ **PRO TV (1080p)** — timeout/os error: The read operation timed out  
  `https://aes.m3u8simplu.workers.dev/protv/index.m3u8`
...
- ❌ **Telemundo (1080p)** — connection error: [Errno -2] Name or service not known  
  `https://streamvidex.qzz.io/videx/telemundo/index.m3u8`
- ❌ **Tele Pam (1080p)** — HTTP 404  
...
- ❌ **Universal Crime (1080p)** — HTTP 404  
  `http://bantel-cdn1.iptvperu.tv:1935/btnscrtn/universalcrime/playlist.m3u8`
- ❌ **Twoja.TV (1080p)** — HTTP 404  
...
## English - Lifestyle (133/206 working)
...
- ❌ **National Geographic (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/natgeo/index.m3u8`
...
- ❌ **History (576p)** — timeout/os error: The read operation timed out  
  `https://aes.m3u8simplu.workers.dev/history/index.m3u8`
...
## English - Movies (89/104 working)
- ❌ **FILMBOX+ Love & Crime Romania (576p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/filmboxstars/index.m3u8`
...
- ❌ **HMTV (720p)** — got HTML/error page instead of stream  
...
- ❌ **BBC Earth Romania (720p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/bbcearth/index.m3u8`
...
- ❌ **Islam Channel (576p) [Not 24/7]** — HTTP 404  
...
- ❌ **Fox Sports 2** — connection error: [Errno -2] Name or service not known  
...
## Hindi - Entertainment (210/368 working)
...
- ❌ **DD Chhattisgarh (720p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/15/master.m3u8`
- ❌ **DD Madhya Pradesh (720p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/31/master.m3u8`
- ❌ **DD National SD (576p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/11/master.m3u8`
- ❌ **DD Rajasthan (720p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/34/master.m3u8`
- ❌ **DD Uttar Pradesh (720p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/36/master.m3u8`
- ❌ **DD Yadagiri (576p)** — got HTML/error page instead of stream  
  `https://cdn-1.pishow.tv/live/21/master.m3u8`
- ❌ **DD Uttarakhand (720p)** — got HTML/error page instead of stream  
...
- ❌ **Sony Channel Andes (1080p)** — HTTP 404  
...
- ❌ **Aradana TV (576p)** — got HTML/error page instead of stream  
...
- ❌ **Dhamaal (576p)** — got HTML/error page instead of stream  
...
- ❌ **Dhamaka Movies B4U (576p)** — got HTML/error page instead of stream  
...
- ❌ **Mahaa News** — got HTML/error page instead of stream  
...
- ❌ **Antena Stars (720p)** — HTTP 503  
  `https://aes.m3u8simplu.workers.dev/antenastars/index.m3u8`
