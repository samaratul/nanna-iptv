...
Checked **4054** streams — **3135 working**, **919 dead** (22.7% dead).
...
## English - Entertainment (2008/2317 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **Nicktoons** — HTTP 401  
  `http://193.24.244.60:1001/udp/239.254.5.227:6060`
...
## English - Lifestyle (133/213 working)
...
- ❌ **News12 Conneticut [Geo-blocked]** — HTTP 408  
...
- ❌ **NBC Sports Bay Area (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
  `https://messi.damitv.st/papi/ts/nbc-sports-bayarea/playlist.m3u8`
- ❌ **NBC Sports Philadelphia (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
...
- ❌ **Unite8 Sports 2** — connection error: timed out  
...
## Hindi - Entertainment (224/369 working)
...
- ❌ **StarPlus HD (1080i)** — connection error: timed out  
...
- ❌ **Colors HD** — connection error: timed out  
...
- ❌ **AfroLandTV WW (1080p)** — HTTP 400  
  `https://stream.ads.ottera.tv/playlist.m3u8?content_livestream=1&network_id=15235`
...
- ❌ **Unite8 Sports 1** — connection error: timed out  
