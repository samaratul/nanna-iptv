...
Checked **3887** streams — **3064 working**, **823 dead** (21.2% dead).
...
## English - Entertainment (1918/2180 working)
...
- ❌ **Master Chefs Academy TV (720p)** — connection error: timed out  
  `https://platform-iuoamc.uk/iptv/mca-tv/index.m3u8`
- ❌ **NRBTV (720p)** — HTTP 403  
...
- ❌ **Romedy Now (576p)** — connection error: [Errno 111] Connection refused  
...
## English - Lifestyle (127/211 working)
...
- ❌ **Kantipur Max [Geo-blocked]** — connection error: timed out  
