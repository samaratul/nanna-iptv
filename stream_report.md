...
Checked **4087** streams — **3187 working**, **900 dead** (22.0% dead).
...
## English - Entertainment (2046/2356 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **LaLiga Hypermotion (1080p)** — timeout/os error: timed out  
...
- ❌ **Sky Sports Football (1080p)** — connection error: timed out  
...
- ❌ **First India News (360p) [Not 24/7]** — HTTP 404  
