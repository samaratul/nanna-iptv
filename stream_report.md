...
Checked **4045** streams — **2854 working**, **1191 dead** (29.4% dead).
...
## English - Devotional (24/26 working)
- ❌ **NCIS: Los Angeles** — HTTP 404  
...
## English - Entertainment (1739/2308 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **ACN TV** — connection error: [SSL: TLSV1_UNRECOGNIZED_NAME] tlsv1 unrecognized name (_ssl.c:1010)  
  `https://cdn.acnlive.net/LiveApp/streams/hold_the_line.m3u8`
...
- ❌ **Advocate Broadcasting Network (576p)** — HTTP 404  
...
- ❌ **Best of Paradise Hotel: Finalveckan** — HTTP 404  
  `https://jmp2.uk/plu-65e97d41f7f0af0008da2543.m3u8`
- ❌ **Best of Paradise Hotel: Kyssar & kärlek** — HTTP 404  
  `https://jmp2.uk/plu-65b1077e0d9ab40008245b20.m3u8`
- ❌ **Best of Paradise Hotel: Pandoras Ask** — HTTP 404  
  `https://jmp2.uk/plu-65e97d760d456100082da660.m3u8`
- ❌ **Best of Paradise Hotel: Skolveckan** — HTTP 404  
  `https://jmp2.uk/plu-65e97cd118036500082ed0ce.m3u8`
- ❌ **Best of The Drew Barrymore Show** — HTTP 404  
...
- ❌ **Britain's Next Top Model** — HTTP 404  
...
- ❌ **De unge mødre** — HTTP 404  
  `https://jmp2.uk/plu-69172a4fcf4a1101befdd894.m3u8`
- ❌ **Den gule sofa med Allan Sindberg** — HTTP 404  
...
- ❌ **Ex On The Beach** — HTTP 404  
  `https://jmp2.uk/plu-61c0909b872c650008ed42e4.m3u8`
- ❌ **Everybody Hates Chris** — HTTP 404  
...
- ❌ **Forsidefruer** — HTTP 404  
  `https://jmp2.uk/plu-61c19dcefbb4b50007d242e1.m3u8`
- ❌ **For lækker til love** — HTTP 404  
...
- ❌ **Gustav & Linse på udebane** — HTTP 404  
...
- ❌ **Lyxfällan Danmark** — HTTP 404  
  `https://jmp2.uk/plu-61c19165decece0007e9b2f3.m3u8`
- ❌ **Lyxfällan Norge** — HTTP 404  
...
- ❌ **MasterChef Danmarks største madtalenter** — HTTP 404  
...
- ❌ **Med kniven for struben** — HTTP 404  
...
- ❌ **Merry Christmas from Viafree** — HTTP 404  
...
- ❌ **Ridiculousness Nya avsnitt** — HTTP 404  
  `https://jmp2.uk/plu-68dfa1e7fae18f8db6218703.m3u8`
- ❌ **Ridiculousness Nye afsnit** — HTTP 404  
...
- ❌ **Robinson Ekspeditionen** — HTTP 404  
...
- ❌ **Sabrina the Teenage Witch** — HTTP 404  
...
- ❌ **SEC Network (720p)** — HTTP 404  
  `http://40.160.24.55/SEC_NETWORK/index.m3u8`
- ❌ **Scorpion** — HTTP 404  
  `https://jmp2.uk/plu-63a1c9c2847a090007f248da.m3u8`
- ❌ **Scorpion** — HTTP 404  
  `https://jmp2.uk/plu-63a1caefc8d285000799e8af.m3u8`
- ❌ **SGTV (Seminole County FL) (1080p)** — HTTP 404  
  `https://live.seminolecountyfl.gov/live-2/live/stream-1/live.m3u8`
- ❌ **Skönhetsfällan Danmark** — HTTP 404  
  `https://jmp2.uk/plu-643808dce0789d00084797f6.m3u8`
- ❌ **Skønne ombygninger** — HTTP 404  
  `https://jmp2.uk/plu-61c19d329b8260000744331b.m3u8`
- ❌ **Slice (720p)** — HTTP 404  
  `http://40.160.24.55/SLICE/index.m3u8`
- ❌ **Smithsonian Channel Selects** — HTTP 404  
...
- ❌ **Stugfixarna Norge** — HTTP 404  
  `https://jmp2.uk/plu-61c18ec6ac860c0007684981.m3u8`
- ❌ **SvampBob Fyrkant (720p)** — HTTP 404  
  `https://jmp2.uk/plu-61c0ba0816e2fd00086cb6b1.m3u8`
- ❌ **SvampeBob Firkant (720p)** — HTTP 404  
  `https://jmp2.uk/plu-61c09ac98a80a4000703f992.m3u8`
- ❌ **Svenska Hollywoodfruar** — HTTP 404  
  `https://jmp2.uk/plu-61c1921610d254000727eebd.m3u8`
- ❌ **Svenska Truckers** — HTTP 404  
...
- ❌ **The Millers** — HTTP 404  
  `https://jmp2.uk/plu-69afeefa0a7f2095e768401c.m3u8`
- ❌ **The New Detectives** — HTTP 404  
...
- ❌ **Til julefrokost hos r8Dio** — HTTP 404  
  `https://jmp2.uk/plu-69256bd7db5cc2f81d8a1a08.m3u8`
- ❌ **Til Middag Hos** — HTTP 404  
...
- ❌ **True crime från Viaplay** — HTTP 404  
...
- ❌ **World Fishing Network (1080p)** — HTTP 404  
...
## English - Lifestyle (128/205 working)
...
- ❌ **MTV Dating (720p)** — HTTP 404  
  `https://jmp2.uk/plu-6851407c21f49d1b9d177493.m3u8`
- ❌ **MTV Reality (720p)** — HTTP 404  
...
- ❌ **Euronews English (720p)** — HTTP 404  
...
- ❌ **Nigbati (720p) [Not 24/7]** — HTTP 404  
...
- ❌ **Teleislas (486p) [Not 24/7]** — HTTP 404  
...
- ❌ **Unite8 Sports 2** — connection error: [Errno 111] Connection refused  
...
## Hindi - Entertainment (228/372 working)
...
- ❌ **Star Channel Latin America (1080p)** — connection error: timed out  
  `http://45.162.193.35/STAR_CHANNEL/index.m3u8`
- ❌ **Pluto TV Star Trek** — HTTP 404  
...
- ❌ **Zee Bollywood (576p)** — connection error: [Errno 111] Connection refused  
...
- ❌ **Love Island: All Stars** — HTTP 404  
  `https://jmp2.uk/plu-68ad8bececd330dcb0f050b5.m3u8`
...
- ❌ **Sony Movies Latin America (720p)** — HTTP 404  
...
- ❌ **MTV HD** — HTTP 403  
  `https://maamusic.keralive.workers.dev/v1/master/a797c00cba954265ba781f92a57e2cf5/index.m3u8`
...
- ❌ **Unite8 Sports 1** — timeout/os error: [Errno 104] Connection reset by peer  
...
## Nepali - Entertainment (36/70 working)
...
- ❌ **PONTV (720p)** — timeout/os error: timed out  
