...
Checked **3886** streams — **3079 working**, **807 dead** (20.8% dead).
...
## English - Entertainment (1934/2181 working)
...
## English - Lifestyle (130/211 working)
...
## English - Music (115/132 working)
- ❌ **MTV Azerbaijan Ⓢ Ⓨ** — got HTML/error page instead of stream  
  `https://www.youtube.com/@MTVAzerbaijan/live`
- ❌ **MTV Ava** — timeout/os error: Remote end closed connection without response  
  `https://live-fi.tvkaista.net/ava/live.m3u8?src=freetv`
- ❌ **MTV3** — timeout/os error: Remote end closed connection without response  
...
## Hindi - Entertainment (233/371 working)
...
- ❌ **STAR Channel (Finland) (720p)** — timeout/os error: Remote end closed connection without response  
...
## Nepali - Entertainment (43/57 working)
- ❌ **NTV Kenya** — HTTP 403  
