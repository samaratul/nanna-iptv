...
Checked **3892** streams — **3070 working**, **822 dead** (21.1% dead).
...
## English - Entertainment (1927/2208 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **HITS NOW SD (720p)** — HTTP 530  
  `https://usatv.dpdns.org/usatv/hitsnow_sd/index.m3u8`
...
- ❌ **Ontario Parliamentary Network (720p)** — timeout/os error: Remote end closed connection without response  
...
## English - Lifestyle (126/207 working)
...
## English - Movies (88/105 working)
- ❌ **Box Movie 1 (720p)** — HTTP 530  
  `https://usatv.dpdns.org/usatv/fpt_box_movie_1/index.m3u8`
...
- ❌ **CNN-News18 Ⓨ** — got HTML/error page instead of stream  
  `https://www.youtube.com/watch?v=jrNW1xqVT6c`
- ❌ **Sky TG24 Ⓖ** — HTTP 403  
...
## Hindi - Entertainment (225/353 working)
...
- ❌ **News18 India Ⓨ** — got HTML/error page instead of stream  
  `https://www.youtube.com/watch?v=lLW9NIHqbwQ`
...
## Nepali - Entertainment (43/56 working)
- ❌ **NTV Ⓖ** — HTTP 403  
