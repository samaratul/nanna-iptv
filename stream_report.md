...
Checked **4050** streams — **3191 working**, **859 dead** (21.2% dead).
...
## English - Entertainment (2044/2329 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **BBC Red Button 15 (720p) [Geo-blocked]** — connection error: [SSL: TLSV1_ALERT_INTERNAL_ERROR] tlsv1 alert internal error (_ssl.c:1010)  
  `https://ve-cmaf-push-uk-live.akamaized.net/x=4/i=urn:bbc:pips:service:uk_bbc_stream_015/iptv_hd_abr_v1.mpd`
- ❌ **BBC Red Button 16 (720p) [Geo-blocked]** — connection error: [SSL: TLSV1_ALERT_INTERNAL_ERROR] tlsv1 alert internal error (_ssl.c:1010)  
...
## Hindi - Entertainment (226/365 working)
...
## Nepali - Devotional (2/3 working)
- ❌ **Angel TV Nepal (720p)** — timeout/os error: The read operation timed out  
  `https://janya-digimix.akamaized.net/vglive-sk-109639/nepali/ngrp:angelnepali_all/playlist.m3u8`
