...
Checked **4057** streams — **3114 working**, **943 dead** (23.2% dead).
...
## English - Entertainment (1988/2319 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **ACN TV** — connection error: [Errno -2] Name or service not known  
...
- ❌ **AMC+ (720p)** — HTTP 404  
  `https://gpuserver3.tier1streams.com/AMC_PLUS/index.m3u8`
...
- ❌ **ArubaTV +** — connection error: [Errno 111] Connection refused  
...
- ❌ **Dabl (720p)** — HTTP 404  
  `http://40.160.24.56/DABL/index.m3u8`
- ❌ **CTV3 (720p)** — HTTP 403  
...
- ❌ **FX (720p)** — HTTP 403  
  `http://185.102.171.218/FOX/index.m3u8`
- ❌ **FX Life (720p)** — HTTP 403  
  `http://185.102.171.218/FOX_Life/index.m3u8`
...
- ❌ **MGM+ (1080p)** — timeout/os error: The read operation timed out  
...
- ❌ **MSG 2 (720p)** — timeout/os error: timed out  
...
- ❌ **NACTV** — connection error: _ssl.c:993: The handshake operation timed out  
...
- ❌ **ROCK Action HD (576p)** — connection error: timed out  
  `http://202.169.224.202:8800/udp/239.9.1.1:1234`
- ❌ **ROCK Entertainment (576p)** — connection error: timed out  
  `http://202.169.224.202:8800/udp/239.9.1.8:1234`
...
## English - Lifestyle (131/213 working)
...
- ❌ **Nicktoons (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/nicktoons-usa/playlist.m3u8`
...
- ❌ **Showtime Family Zone (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/showtimefamilyzone-usa/playlist.m3u8`
- ❌ **Showtime Women (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/showtimewomen-usa/playlist.m3u8`
- ❌ **Showtime Next (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/showtimenext-usa/playlist.m3u8`
...
- ❌ **Telemundo West (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/telemundo-usa/playlist.m3u8`
...
- ❌ **Nat Geo People (1080p)** — HTTP 403  
  `http://starcius-cinema.com/11589/index.m3u8`
...
- ❌ **FX Movie Channel (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fxm-usa/playlist.m3u8`
...
- ❌ **Starz Cinema (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/starzcinema-usa/playlist.m3u8`
...
- ❌ **Fox News International (720p)** — HTTP 404  
  `https://gpuserver3.tier1streams.com/FOX/index.m3u8`
...
- ❌ **BBC Earth (1080p)** — HTTP 403  
  `http://starcius-cinema.com/11586/index.m3u8`
...
- ❌ **Fox Sports 1 (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fox-sports-1/playlist.m3u8`
- ❌ **Fox Sports 2 (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fox-sports-2/playlist.m3u8`
- ❌ **Fox Sports 503 (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fox-sports-503/playlist.m3u8`
- ❌ **Fox Sports 505 (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fox-sports-505/playlist.m3u8`
- ❌ **Fox Sports 506 (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
  `https://messi.damitv.st/papi/ts/fox-sports-506/playlist.m3u8`
...
- ❌ **NFL Network (1080p) [Geo-blocked]** — got HTML/error page instead of stream  
...
## Hindi - Entertainment (227/370 working)
...
- ❌ **Utsav Bharat (576p)** — connection error: [Errno -2] Name or service not known  
