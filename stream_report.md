...
Checked **3846** streams — **2979 working**, **867 dead** (22.5% dead).
...
## English - Entertainment (1907/2223 working)
...
- ❌ **ESPNU HD (720p)** — connection error: timed out  
...
- ❌ **Nick Jr. (576p)** — HTTP 404  
  `http://103.185.24.134:3001/NICK-JR/index.m3u8`
- ❌ **Nickelodeon (1080p)** — HTTP 404  
...
- ❌ **BBC UHD 1 (1080p)** — timeout/os error: timed out  
...
- ❌ **Fox Sports 1 (720p)** — connection error: timed out  
...
## Hindi - Entertainment (229/371 working)
...
- ❌ **Enterr 10 Rangeela (1080p)** — HTTP 404  
  `http://103.185.24.134:3001/SUN-BANGLA-HD/index.m3u8`
- ❌ **Hungama TV (576p)** — HTTP 404  
...
- ❌ **Sony Max 1 (720p)** — timeout/os error: [Errno 104] Connection reset by peer  
...
## Nepali - Entertainment (45/62 working)
