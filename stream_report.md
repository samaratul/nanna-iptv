...
Checked **3911** streams — **3100 working**, **811 dead** (20.7% dead).
...
## English - Devotional (22/27 working)
...
## English - Entertainment (1933/2217 working)
...
- ❌ **KCAT Public Media TV (1080p)** — timeout/os error: The read operation timed out  
...
- ❌ **MuzzOne** — connection error: [SSL: WRONG_VERSION_NUMBER] wrong version number (_ssl.c:1010)  
...
- ❌ **History Latin America (1080p)** — HTTP 404  
