...
## English - Entertainment (1925/2184 working)
...
- ❌ **WTVJ-DT1 (1080p)** — HTTP 503  
  `https://nbculocallive.akamaized.net/hls/live/2037498/miami/stream1/master.m3u8`
- ❌ **XTV (720p)** — HTTP 403  
...
- ❌ **CW (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
...
- ❌ **beIN Sports USA (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
  `https://messi.damitv.st/papi/ts/beinsports-usa/playlist.m3u8`
- ❌ **Golf Channel (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
  `https://messi.damitv.st/papi/ts/golfchannel-usa/playlist.m3u8`
- ❌ **MLB Network (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
...
- ❌ **S Sport (720p)** — connection error: [SSL: SSLV3_ALERT_HANDSHAKE_FAILURE] sslv3 alert handshake failure (_ssl.c:1010)  
  `https://corestream.siteyaptim.live/s-sport/index.m3u8`
- ❌ **S Sport 2 (720p)** — connection error: [SSL: SSLV3_ALERT_HANDSHAKE_FAILURE] sslv3 alert handshake failure (_ssl.c:1010)  
...
## Hindi - Entertainment (234/373 working)
...
- ❌ **Shemaroo TV (720p)** — connection error: [Errno -3] Temporary failure in name resolution  
  `https://airtelapp.shemaroo.com/shemarootv/smil:shemarootvadp.smil/playlist.m3u8`
- ❌ **Shemaroo Marathi Bana (720p)** — connection error: [Errno -3] Temporary failure in name resolution  
