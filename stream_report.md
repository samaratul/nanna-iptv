...
Checked **3888** streams — **3082 working**, **806 dead** (20.7% dead).

## Bhojpuri - Entertainment (7/12 working)
- ❌ **Manoranjan Prime (576p)** — HTTP 404  
  `https://mumt06.tangotv.in/qYyB8fXVMANORANJANPRIME/index.m3u8`
...
## English - Entertainment (1932/2183 working)
...
## Hindi - Entertainment (235/371 working)
...
- ❌ **Raftaar Media (576p)** — timeout/os error: The read operation timed out  
...
- ❌ **Darshan 24 (576p)** — timeout/os error: The read operation timed out  
  `https://mumt05.tangotv.in/87NeALx2DARSHAN24/index.m3u8`
- ❌ **E 24 (576p)** — timeout/os error: The read operation timed out  
...
## Nepali - News (14/17 working)
- ❌ **News 24 MP & Chhattisgarh (576p)** — HTTP 404  
  `https://mumt04.tangotv.in/m18aqlK4NEWS24MPCG/index.m3u8`
