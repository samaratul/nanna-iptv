...
Checked **4046** streams — **3176 working**, **870 dead** (21.5% dead).
...
## English - Entertainment (2036/2328 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **TV Maná English (1080p)** — connection error: [Errno -2] Name or service not known  
...
- ❌ **World Harvest TV (360p)** — HTTP 404  
...
- ❌ **Westerns 4U (1080p)** — connection error: timed out  
...
- ❌ **CNN Prima News** — connection error: timed out  
...
- ❌ **Maná Church Online (1080p) [Not 24/7]** — connection error: [Errno -2] Name or service not known  
...
- ❌ **Prima STAR** — connection error: timed out  
...
- ❌ **Star Gold Thrills (576p)** — connection error: [Errno 111] Connection refused  
