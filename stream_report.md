...
Checked **3868** streams — **3124 working**, **744 dead** (19.2% dead).
...
## English - Entertainment (1969/2193 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **AccuWeather Now (1080p)** — HTTP 500  
...
- ❌ **BBC News Asia Pacific (576p)** — HTTP 530  
...
- ❌ **Türkmenistan (406p) [Not 24/7]** — HTTP 403  
...
## Hindi - Entertainment (240/359 working)
...
- ❌ **Star Kentrikis Elladas (1080p)** — HTTP 404  
  `https://telmaco-cdn.akamaized.net/starcgr/default/index.m3u8`
...
- ❌ **Animax Asia India (1080p) [Geo-blocked]** — HTTP 500  
