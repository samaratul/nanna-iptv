...
Checked **4057** streams — **3136 working**, **921 dead** (22.7% dead).
...
## English - Entertainment (2015/2319 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **MTV Sub (720p)** — timeout/os error: Remote end closed connection without response  
  `https://live-fi.tvkaista.net/sub/live.m3u8`
- ❌ **MTV3 (720p)** — timeout/os error: Remote end closed connection without response  
  `https://live-fi.tvkaista.net/mtv3/live.m3u8`

## English - News (282/484 working)
- ❌ **Sky TG24 Ⓖ** — HTTP 403  
...
## Hindi - Entertainment (226/370 working)
...
- ❌ **Awaaz India TV (720p) [Not 24/7]** — HTTP 404  
