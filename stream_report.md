...
Checked **3838** streams — **3007 working**, **831 dead** (21.7% dead).
...
## English - Entertainment (1883/2214 working)
...
- ❌ **aurLife HD (614p)** — connection error: timed out  
...
- ❌ **Laff WJLP (576p)** — timeout/os error: timed out  
  `http://4.30.180.36:8420/laff/index.m3u8?token=test`
...
- ❌ **BBC One Wales HD (1080p)** — HTTP 404  
...
## Hindi - Entertainment (264/375 working)
...
- ❌ **TV30 India (1080p)** — connection error: timed out  
  `https://stream.tv30bharat.com/hls/shree/bhattji.m3u8`
