...
Checked **3886** streams — **3084 working**, **802 dead** (20.6% dead).
...
## English - Entertainment (1930/2181 working)
...
- ❌ **WION Ⓨ** — got HTML/error page instead of stream  
  `https://www.youtube.com/@WION/live`
...
- ❌ **Ajman TV (1080p)** — connection error: [Errno -3] Temporary failure in name resolution  
...
- ❌ **Greensboro TV (Greensboro NC) (720p)** — connection error: timed out  
...
- ❌ **Legislative Assembly of Ontario** — connection error: timed out  
  `https://temp3.isilive.ca/live/_definst_/ontla/house-en/playlist.m3u8`
- ❌ **Legislative Assembly TV Nunavut** — connection error: timed out  
...
- ❌ **PRIDEtv LATAM (1080p)** — timeout/os error: The read operation timed out  
...
- ❌ **Telemundo East HD (1080p)** — connection error: timed out  
  `http://45.190.13.8/TelemundoHD/index.m3u8`
...
## English - Lifestyle (131/211 working)
...
- ❌ **CHCO-TV (720p) [Geo-blocked]** — connection error: timed out  
...
- ❌ **Viasat History (720p)** — connection error: [Errno -2] Name or service not known  
...
- ❌ **MTV** — timeout/os error: timed out  
  `http://99.27.51.147:8080/MTV/index.m3u8`

## English - News (288/477 working)
- ❌ **Sky TG24 Ⓖ** — HTTP 403  
...
- ❌ **CLTV 36 (720p) [Not 24/7]** — connection error: timed out  
...
## Hindi - Devotional (13/15 working)
...
## Hindi - Entertainment (237/371 working)
...
- ❌ **Zee Bollywood (580p)** — connection error: [Errno 111] Connection refused  
...
- ❌ **Sony Yay!** — connection error: [Errno 111] Connection refused  
...
## Hindi - Movies (12/37 working)
- ❌ **B4U Movies APAC (720p)** — connection error: [Errno 111] Connection refused  
...
- ❌ **beIN Movies Stars** — connection error: [Errno -2] Name or service not known  
...
- ❌ **B4U Music APAC (720p)** — connection error: [Errno 111] Connection refused  
...
- ❌ **Epic Bharat (576p)** — connection error: timed out  
  `http://103.175.73.12:8080/live/471/master.m3u8`
