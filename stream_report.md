...
Checked **3891** streams — **3047 working**, **844 dead** (21.7% dead).
...
## English - Entertainment (1870/2210 working)
...
- ❌ **JTBS Classic** — connection error: [SSL: TLSV1_ALERT_INTERNAL_ERROR] tlsv1 alert internal error (_ssl.c:1010)  
...
- ❌ **Nickelodeon (United States) (720p)** — HTTP 404  
...
## English - Lifestyle (87/170 working)
- ❌ **CS History** — HTTP 502  
...
- ❌ **National Geographic (United States) HD East (720p)** — HTTP 404  
...
## Hindi - Entertainment (303/413 working)
...
- ❌ **Public First (576p)** — HTTP 404  
  `https://mumt06.tangotv.in/qYyB8fXVPUBLICFIRST/index.m3u8`
...
- ❌ **Ray TV HD SD (576p)** — empty response body  
