...
Checked **3910** streams — **3050 working**, **860 dead** (22.0% dead).
...
- ❌ **God Stands Kids Club TV** — connection error: [Errno -3] Temporary failure in name resolution  
...
## English - Entertainment (1884/2223 working)
...
- ❌ **AXN Spin (Hungary)** — got HTML/error page instead of stream  
...
- ❌ **BATV Government TV (480p)** — got HTML/error page instead of stream  
  `https://reflect-batv.cablecast.tv/live-3/live/live.m3u8`
- ❌ **BATV (480p)** — got HTML/error page instead of stream  
...
- ❌ **ABC KATC (1080p)** — connection error: timed out  
...
- ❌ **City of Loveland TV (1080p)** — got HTML/error page instead of stream  
...
- ❌ **Comedy Central (Romania)** — HTTP 403  
...
- ❌ **G10TV (1080p)** — got HTML/error page instead of stream  
...
- ❌ **Disney XD (United States) (720p)** — timeout/os error: timed out  
...
- ❌ **GoUSA TV (720p)** — connection error: [Errno -2] Name or service not known  
...
- ❌ **Fuse (1080p)** — timeout/os error: timed out  
...
- ❌ **ION TV (720p)** — HTTP 404  
  `http://23.237.104.106:8080/USA_ION/index.m3u8`
...
- ❌ **Oireachtas TV Dail Eireann (720p)** — HTTP 403  
...
- ❌ **MSG (720p)** — timeout/os error: timed out  
...
- ❌ **Nicktoons (Poland)** — connection error: timed out  
...
- ❌ **SEC Network (1080p)** — timeout/os error: timed out  
...
- ❌ **TBCN (480p)** — got HTML/error page instead of stream  
...
- ❌ **Thornton 8 (1080p)** — got HTML/error page instead of stream  
...
- ❌ **TeenNick (United States) (576p)** — timeout/os error: timed out  
...
- ❌ **TV1 (Malaysia) (1080p)** — connection error: timed out  
...
- ❌ **TV2 (Malaysia) (1080p)** — connection error: timed out  
...
- ❌ **AXN Spin (Poland)** — connection error: timed out  
...
## English - Lifestyle (90/168 working)
- ❌ **CS History** — HTTP 502  
...
- ❌ **CBeebies (720p) [Geo-blocked]** — HTTP 403  
...
- ❌ **City of Fairfield Channel 26 (720p) [Geo-blocked]** — got HTML/error page instead of stream  
...
- ❌ **KFON TV (720p) [Geo-blocked]** — got HTML/error page instead of stream  
...
- ❌ **National Geographic (Romania)** — got HTML/error page instead of stream  
...
- ❌ **TechStorm (720p) [Geo-blocked]** — HTTP 400  
...
- ❌ **Viasat History (Romania)** — HTTP 403  
...
- ❌ **BBC Four (720p) [Geo-blocked]** — HTTP 403  
...
- ❌ **BBC One (720p) [Geo-blocked]** — HTTP 403  
...
- ❌ **BBC Scotland (720p) [Geo-blocked]** — HTTP 403  
...
- ❌ **Sky Sports Cricket (Ireland) (1080p)** — connection error: [Errno -2] Name or service not known  
...
## Hindi - Entertainment (291/410 working)
...
- ❌ **Sach Bedhadak (576p)** — HTTP 404  
  `https://sbnews.nexcdn.online/sbnews/live/index.m3u8`
...
- ❌ **Zoom (India) Global (720p)** — connection error: [Errno -5] No address associated with hostname  
...
- ❌ **Star TV (Mongolia) (1080p)** — HTTP 404  
...
- ❌ **Jaya TV (India) (1080p)** — connection error: timed out  
...
- ❌ **Punjabi Zindabad TV (360p) [Not 24/7]** — connection error: [Errno -2] Name or service not known  
...
## Nepali - Entertainment (47/66 working)
...
- ❌ **Ray TV HD SD (576p)** — connection error: [Errno 111] Connection refused  
...
- ❌ **LenTV24** — got HTML/error page instead of stream  
