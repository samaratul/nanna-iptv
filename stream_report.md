...
Checked **3881** streams — **3083 working**, **798 dead** (20.6% dead).
...
## English - Entertainment (1931/2179 working)
...
- ❌ **AXN Latin America South** — connection error: timed out  
  `http://45.228.235.116:8000/play/a0iy/index.m3u8`
...
## English - Lifestyle (129/211 working)
...
- ❌ **Fox (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
  `https://messi.damitv.st/papi/ts/fox-usa/playlist.m3u8`
- ❌ **Freeform (1080p) [Geo-blocked]** — timeout/os error: The read operation timed out  
...
- ❌ **BBC News (1080p)** — connection error: [SSL: TLSV1_ALERT_INTERNAL_ERROR] tlsv1 alert internal error (_ssl.c:1010)  
...
## Hindi - Devotional (12/15 working)
...
## Hindi - Entertainment (234/369 working)
