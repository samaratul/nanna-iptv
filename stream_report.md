...
Checked **4053** streams — **3106 working**, **947 dead** (23.4% dead).
...
## English - Entertainment (1960/2316 working)
- ❌ **Blue Sky** — HTTP 403  
...
- ❌ **Prudent Media (1080p)** — got HTML/error page instead of stream  
...
- ❌ **Telemundo West (720p)** — connection error: timed out  
  `http://181.119.108.43:9001/play/a044/index.m3u8`
...
## English - Lifestyle (129/205 working)
...
- ❌ **MTV2 (1080p)** — HTTP 404  
  `http://40.160.24.53/MTV2/index.m3u8`
...
## Hindi - Entertainment (237/373 working)
