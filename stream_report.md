...
Checked **3865** streams — **3038 working**, **827 dead** (21.4% dead).

## Bhojpuri - Entertainment (8/12 working)
- ❌ **Pasand TV (576p)** — HTTP 502  
  `http://103.175.73.12:8080/live/708/master.m3u8`
- ❌ **Zee Biskope (576p)** — HTTP 502  
...
## English - Entertainment (1919/2178 working)
...
- ❌ **CNA (480p)** — connection error: timed out  
  `https://streams.comclark.com/pknsd/channel_news_asia/playlist.m3u8`
...
- ❌ **World Harvest TV (360p)** — connection error: timed out  
...
- ❌ **AXN Latin America (1080p)** — HTTP 403  
  `http://15.204.246.24:8080/AXNHD/index.m3u8`
...
## English - Lifestyle (127/209 working)
...
- ❌ **Disney Channel (720p) [Geo-blocked]** — HTTP 403  
...
- ❌ **National Geographic (720p)** — HTTP 403  
...
## English - Music (121/132 working)
- ❌ **MTV Azerbaijan Ⓢ Ⓨ** — got HTML/error page instead of stream  
  `https://www.youtube.com/@MTVAzerbaijan/live`
- ❌ **MTV Latin America (1080p)** — HTTP 403  
  `http://15.204.246.24:8080/MTVHD/index.m3u8`
- ❌ **GMTV (1080p)** — HTTP 404  
...
- ❌ **CGTN Français (1080p) [Not 24/7]** — HTTP 404  
...
- ❌ **Star Sports Khel (1080p)** — HTTP 502  
...
## Hindi - Entertainment (219/354 working)
...
- ❌ **Star Channel Latin America (1080p)** — HTTP 403  
  `http://15.204.246.24:8080/STARCHANNELHD/index.m3u8`
...
- ❌ **Anmol TV (576p)** — HTTP 502  
  `http://103.175.73.12:8080/live/256/256_0.m3u8`
- ❌ **Big Magic (576p)** — HTTP 502  
...
- ❌ **Goldmines (576p)** — HTTP 502  
  `http://103.175.73.12:8080/live/53/53_0.m3u8`
- ❌ **Goldmines Bollywood (576p)** — HTTP 502  
...
- ❌ **B4U Music (576p)** — HTTP 502  
  `http://103.175.73.12:8080/live/157/master.m3u8`

## Hindi - News (84/108 working)
...
## Nepali - Entertainment (40/57 working)
- ❌ **NTV Ⓖ** — HTTP 403  
